...
delete from menu;
insert into menu (id_menu,orden,nombre,url,activo,icon) values ( 1, 1, 'Inicio', '/index',1,'fas fa-tachometer-alt'),
                                                               (2, 20,  'Entrenar', '/programa',1,'fas fas fa-dumbbell'),
                                                               (3, 30,  'Mis rutinas', '/misrutinas',1,'fas fa-table'),
                                                               (4, 40,  'Chats', '/chat',1,'far fa-comment-alt'),
                                                               (5, 35,  'Entrenador', '/chat/entrenador',1,'far fa-comment-alt'),
                                                               (6, 48,  'Cliente', '/chat/cliente',1,'far fa-comment-alt');
